...
<head>
    ...
    <meta name="keywords" content="service AC di batam,Service AC terdekat, Service AC terbaik di batam" />
...
<body>
    {{-- <img src="images/wa.png" style="width: 100px; position: fixed!important; z-index:999;" alt=""> --}}
        ...
        <div class="position-fixed" style="z-index: 999; ">
            <div class="position-fixed bottom-0 end-0">
                ...
                <a
                    ...
                    <img src="images/wa.png"style="width:150px;" id="waa"></a>
            ...
            <div class="header_bottom">
                <div class="container-fluid">
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        ...
                        <div class="img"
                            style=" border-radius:50px;    background-size: 96px;
    background-repeat: no-repeat;    width:100px;height:100px; background-color:rgb(255, 255, 255); background-image:url('images/logooo.png')">
                        </div>
    ...
    <section class="about_section layout_padding-bottom" style="margin-top: 40px;" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-6">
                    <div class="detail-box">
                        ...
                        <p>
                            ...
                            Master Pendingin AC - Melayani jasa service maupun pemasangan/instalasi AC diwilayah Batam
                            indonesia, Layanan jasa service elektronik di Batam dan sekitarnya.

                            Dengan didukung oleh para tenaga kerja/Teknisi yg berpengalaman puluhan tahun di bidangnya,
                            sehingga bisa menghasilkan sebuah akhir pekerjaan yang rapih dan berkualitas.

                            Layanan kami ada jaminan bergaransi dalam jasa service yang sudah ditentukan, lama jangka
                            waktu garansi bisa disesuaikan dengan apa yg telah dikerjakan.

                            Harga jasa relatif murah dan harga bisa negotiable sebelum pekerjaan dimulai, ada paket
                            harga yang menarik dari kami dalam service maupun intalasi/pemasangan baru or second.
        ...
        <div class="container ">
            ...
            <div class="row" style="height: 600px; overflow:auto;">
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/cuci copy.png" alt="" style="max-width:202%;max-height:200%;" />
                        </div>
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/freonn.png" alt="" style="max-width:202%;max-height:200%;" />
                        </div>
                        <div class="detail-box" style="margin-top:20px;">
                            <h5>
                                Isi Freon </h5>
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/bongkar.png" style="max-width:202%;max-height:200%;" alt="" />
                        </div>
                        <div class="detail-box" style="margin-top:20px;">
                            <h5>
                                Bongkar Pasang
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/pasang.png" style="max-width:202%;max-height:200%;" alt="" />
                        </div>
                        <div class="detail-box" style="margin-top:20px;">
                            <h5>
                                Pemasangan Baru
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/maintenace asli.png" style="max-width:202%;max-height:200%;"alt="" />
                        </div>
                        <div class="detail-box" style="margin-top:20px;">
                            <h5>
                                Maintenance
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/isi.png" style="max-width:202%;max-height:200%;" alt="" />
                        </div>
                        <div class="detail-box" style="margin-top:20px;">
                            <h5>
                                Perbaikan
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/spre.png" style="max-width:202%;max-height:200%;" alt="" />
                        </div>
                        <div class="detail-box" style="margin-top:20px;">
                            <h5>
                                Ganti Spare Part
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/mesin_cuci.png" style="max-width:202%;max-height:200%;"
                                alt="" />
                        </div>
                        <div class="detail-box" style="margin-top:20px;">
                            <h5>
                ...
                <div class="col-sm-6 col-md-4 mx-auto">
                    <div class="box ">
                        <div class="img-box">
                            <img src="images/jual.png" alt="" style="max-width:202%;max-height:200%;" />
                        </div>
                        <div class="detail-box" style="margin-top:20px;">
                            <h5>
    ...
    <section class="service_section layout_padding" id="galeri">
        <div class="container ">
            <div class="heading_container heading_center">
                <h2> Galeri </h2>
            </div>
            <div class="row" style="height: 600px; overflow:auto;">
                ...
                @for ($a = 1; $a <= 8; $a++)
                    <div class="col-sm-6 col-md-4 mx-auto">
                        {{-- <div class="box ">
                            <div class="img-box">
                                <img src="images/gambar ({{ $a }}).jpg" alt=""
                                    style="max-width:202%;max-height:200%;" />
                            </div>

                        </div> --}}

                        <figure class="figure">
                            <img src="images/gambar ({{ $a }}).jpg" class="figure-img img-fluid rounded"
                                alt="...">
    ...
    <section class="contact_section layout_padding" id="alamat">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="container my-5">
                    ...
                    <footer class="text-white text-center text-lg-start bg-grey"
                        style="background-color: rgb(87, 87, 87)">
                        {{-- Grid container --}}
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                                    ...
                                    <ul class="fa-ul" style="margin-left: 1.65em;">
                                        <li class="mb-3">
                                            <span class="fa-li"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="16" height="16" fill="currentColor"
                                                    class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                                                    <path
                                                        d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                                                </svg></span><span class="ms-2">Komplek Ruko Taman Niaga,Batam</span>
                                        </li>
                                        <li class="mb-3">
                                            <span class="fa-li"><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="16" height="16" fill="currentColor"
                                                ...
                                                </svg></span><span class="ms-2">ronaldosefri22@gmail.com</span>
                                        </li>
                                        <li class="mb-3">
                                            <span class="fa-li" style="color: white;"><svg
                                                ...
                                                </svg></span><span class="ms-2">081261771623</span>
                                        </li>
                                    </ul>
                                </div>
                                {{-- Grid column --}}
                                ...
                                {{-- Grid column --}}
                                <div class="col-lg-4 col-md-6 mb-4 mb-md-0" style="overflow: auto">
                                    <div class="map_container">
                                        <iframe
                                            ...
                                            width="300" height="350" style="border:0;" allowfullscreen=""
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="info_items">
                        <div class="row">
                            <div class="col-md-4">
                                <a
                                    href="https://www.google.com/maps/place/Ruko+Niaga+Taras+Batam+Centre/@1.118242,104.093884,16z/data=!4m6!3m5!1s0x31d988a224147be3:0x80b4fba053354a61!8m2!3d1.1182422!4d104.093884!16s%2Fg%2F11hc_dpwb1?hl=en&entry=ttu&g_ep=EgoyMDI0MTExOC4wIKXMDSoASAFQAw%3D%3D">
                                    <div class="item ">
                                        <div class="img-box ">
                            ...
                            <div class="col-md-4">
                                <a href="mailto:ronaldosefri22@gmail.com?subject=Hello%20There&body=Halo.">
                                    <div class="item ">
                                        <div class="img-box">
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                        </div>
                                        <p>
                                            ronaldosefri22@gmail.com
                                        </p>
                                    </div>
                                </a>
                            </div>
    ...
    <footer class="footer_section">
        <div class="container">
            <p>
                ...
                <a href="https://ciptateknik.my.id/">Cipta Teknik AC</a>
            </p>
        </div>
    </footer>

    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-10857947855"></script>
